...
public class PalletTransferRepository {
    ...
    public LiveData<APIResponse> searchPalletLoadResponse(String palletBarcode) {
        final MutableLiveData<APIResponse> mutableLiveData = new MutableLiveData<>();
        API.service().searchPalletLoad(palletBarcode).enqueue(new Callback<APIResponse>() {
            @Override
            public void onResponse(Call<APIResponse> call, Response<APIResponse> response) {
                mutableLiveData.setValue(response.body());
            }
    ...
    public LiveData<APIResponse> postPalletLoadResponse(Integer[] transferNoteIds) {
        final MutableLiveData<APIResponse> mutableLiveData = new MutableLiveData<>();
        API.service().postPalletLoad(transferNoteIds).enqueue(new Callback<APIResponse>() {
            @Override
            public void onResponse(Call<APIResponse> call, Response<APIResponse> response) {
                mutableLiveData.setValue(response.body());
            }
